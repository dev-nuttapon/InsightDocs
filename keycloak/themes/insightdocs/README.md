Keycloak custom theme for InsightDocs
...
2. In Realm settings -> Themes:
   - Login theme: insightdocs
   - Email theme: insightdocs
   - Account theme: insightdocs
...
4. In Clients -> your InsightDocs frontend client:
...
services:
  keycloak:
    volumes:
      - ./themes/insightdocs:/opt/keycloak/themes/insightdocs:ro
    environment:
